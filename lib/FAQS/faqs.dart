                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.only(
                                    left: 8.0, right: 8.0),
                                child: Text(
                                  "Goto the mobile app of Smart Autism Therapist then think about channel name or id which can be anything you desire then send that channel name to your patient via chat then go to video call section and enter the same name then click the button below to start video call.",
                                  style: TextStyle(
                                    color: Colors.black,
                                    fontSize: 16.0,
                                  ),
