...
import 'package:admin/doctors_details/Deleting_Appointment/Doc3_Appointment/doc3_monday_first.dart';
import 'package:admin/doctors_details/Deleting_Appointment/Doc3_Appointment/doc3_monday_second.dart';
import 'package:admin/doctors_details/Deleting_Appointment/Doc3_Appointment/doc3_tuesday_first.dart';
import 'package:admin/doctors_details/Deleting_Appointment/Doc3_Appointment/doc3_tuesday_second.dart';
import 'package:admin/doctors_details/Deleting_Appointment/Doc3_Appointment/doc3_wednesday_first.dart';
import 'package:admin/doctors_details/Deleting_Appointment/Doc3_Appointment/doc3_wednesday_second.dart';
...
class UpdatingAppointment3 extends StatefulWidget {
  // const UpdatingAppointment({ Key? key }) : super(key: key);

  @override
  State<UpdatingAppointment3> createState() => _UpdatingAppointment3State();
}

class _UpdatingAppointment3State extends State<UpdatingAppointment3> {
  final user = FirebaseAuth.instance.currentUser;

  final userRef =
      FirebaseFirestore.instance.collection('Appointment_Doc3_Monday');

  final userRef2 =
      FirebaseFirestore.instance.collection('Appointment_Doc3_Tuesday');
  final userRef3 =
      ...
      snapshot.docs.forEach((DocumentSnapshot doc) {
        ...
        if (itemList[index]["isAvailable"] == "Booked" &&
          ...
          setState(() {
            ...
            itemList[index]["appointment_time"] == "04:00 pm - 06:00 pm" &&
            itemList[index]["day"] == "Monday") {
          setState(() {
                    ...
                    onPressed: () {
                      ...
                      new Future.delayed(const Duration(seconds: 2), () {
                        showDialog(
                            context: context,
                            builder: (context) =>
                                DeletingDoc3FirstMondayAppointment(
                    ...
                    onPressed: () {
                      ...
                      new Future.delayed(const Duration(seconds: 2), () {
                        showDialog(
                            context: context,
                            builder: (context) =>
                                DeletingDoc3SecondMondayAppointment(
                    ...
                    onPressed: () {
                      ...
                      new Future.delayed(const Duration(seconds: 2), () {
                        showDialog(
                            context: context,
                            builder: (context) =>
                                DeletingDoc3FirstTuesdayAppointment(
                    ...
                    onPressed: () {
                      ...
                      new Future.delayed(const Duration(seconds: 2), () {
                        showDialog(
                            context: context,
                            builder: (context) =>
                                DeletingDoc3SecondTuesdayAppointment(
                    ...
                    onPressed: () {
                      ...
                      new Future.delayed(const Duration(seconds: 2), () {
                        showDialog(
                            context: context,
                            builder: (context) =>
                                DeletingDoc3SecondWednesdayAppointment(
