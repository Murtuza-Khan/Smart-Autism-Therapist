...
class DoctorVerification3 extends StatefulWidget {
  // const DoctorVerification({ Key? key }) : super(key: key);

  @override
  State<DoctorVerification3> createState() => _DoctorVerification3State();
}

class _DoctorVerification3State extends State<DoctorVerification3> {
                      ...
                      if (_email == "sohaib123@gmail.com" &&
                        ...
                        new Future.delayed(const Duration(seconds: 2), () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => UpdatingAppointment3()));
                        });
                        // showDialog(
                        //     context: context,
