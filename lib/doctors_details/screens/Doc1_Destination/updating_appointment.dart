...
import 'package:admin/doctors_details/Deleting_Appointment/Doc1_Appointment/doc1_monday_first.dart';
import 'package:admin/doctors_details/Deleting_Appointment/Doc1_Appointment/doc1_monday_second.dart';
import 'package:admin/doctors_details/Deleting_Appointment/Doc1_Appointment/doc1_tuesday_first.dart';
import 'package:admin/doctors_details/Deleting_Appointment/Doc1_Appointment/doc1_tuesday_second.dart';
import 'package:admin/doctors_details/Deleting_Appointment/Doc1_Appointment/doc1_wednesday_first.dart';
import 'package:admin/doctors_details/Deleting_Appointment/Doc1_Appointment/doc1_wednesday_second.dart';
...
class UpdatingAppointment extends StatefulWidget {
  // const UpdatingAppointment({ Key? key }) : super(key: key);

  @override
  State<UpdatingAppointment> createState() => _UpdatingAppointmentState();
}

class _UpdatingAppointmentState extends State<UpdatingAppointment> {
  final user = FirebaseAuth.instance.currentUser;

  final userRef =
      FirebaseFirestore.instance.collection('Appointment_Doc1_Monday');

  final userRef2 =
      FirebaseFirestore.instance.collection('Appointment_Doc1_Tuesday');
  final userRef3 =
      FirebaseFirestore.instance.collection('Appointment_Doc1_Wednesday');
    ...
    userRef.get().then((QuerySnapshot snapshot) {
      snapshot.docs.forEach((DocumentSnapshot doc) {
        ...
        if (itemList[index]["isAvailable"] == "Booked" &&
            itemList[index]["appointment_time"] == "09:00 am - 11:00 am" &&
          ...
          setState(() {
            ...
            itemList[index]["appointment_time"] == "01:00 pm - 03:00 pm" &&
            itemList[index]["day"] == "Monday") {
          setState(() {
                    ...
                    onPressed: () {
                      ...
                      new Future.delayed(const Duration(seconds: 2), () {
                        showDialog(
                            context: context,
                            builder: (context) =>
                                DeletingFirstMondayAppointment(
                    ...
                    onPressed: () {
                      ...
                      new Future.delayed(const Duration(seconds: 2), () {
                        showDialog(
                            context: context,
                            builder: (context) =>
                                DeletingSecondMondayAppointment(
                    ...
                    onPressed: () {
                      ...
                      new Future.delayed(const Duration(seconds: 2), () {
                        showDialog(
                            context: context,
                            builder: (context) =>
                                DeletingFirstTuesdayAppointment(
                    ...
                    onPressed: () {
                      ...
                      new Future.delayed(const Duration(seconds: 2), () {
                        showDialog(
                            context: context,
                            builder: (context) =>
                                DeletingSecondTuesdayAppointment(
                    ...
                    onPressed: () {
                      ...
                      new Future.delayed(const Duration(seconds: 2), () {
                        showDialog(
                            context: context,
                            builder: (context) =>
                                DeletingFirstWednesdayAppointment(
                    ...
                    onPressed: () {
                      ...
                      new Future.delayed(const Duration(seconds: 2), () {
                        showDialog(
                            context: context,
                            builder: (context) =>
                                DeletingSecondWednesdayAppointment(
