...
import 'package:admin/doctors_details/screens/Admin_Uncompleted_Appointment/Admin_uncomplete_appointment_details.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';

class AdminUncompletedAppointmentScreen extends StatefulWidget {
  // final int noAppointment;

  // AdminScreen({this.noAppointment});

  @override
  _AdminUncompletedAppointmentScreenState createState() =>
      _AdminUncompletedAppointmentScreenState();
}

class _AdminUncompletedAppointmentScreenState
    extends State<AdminUncompletedAppointmentScreen> {
