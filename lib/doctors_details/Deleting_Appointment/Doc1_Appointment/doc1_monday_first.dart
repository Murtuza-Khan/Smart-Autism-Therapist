...
class DeletingFirstMondayAppointment extends StatefulWidget {
  final String? title;
  ...
  @override
  State<DeletingFirstMondayAppointment> createState() =>
      _DeletingFirstMondayAppointmentState();
}

class _DeletingFirstMondayAppointmentState
    extends State<DeletingFirstMondayAppointment> {
