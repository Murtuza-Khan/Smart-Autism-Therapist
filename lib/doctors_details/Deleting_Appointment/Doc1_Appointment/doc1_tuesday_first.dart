...
class DeletingFirstTuesdayAppointment extends StatefulWidget {
  final String? title;
  ...
  @override
  State<DeletingFirstTuesdayAppointment> createState() =>
      _DeletingFirstTuesdayAppointmentState();
}

class _DeletingFirstTuesdayAppointmentState
    extends State<DeletingFirstTuesdayAppointment> {
