...
class DeletingDoc2FirstMondayAppointment extends StatefulWidget {
  final String? title;
  ...
  @override
  State<DeletingDoc2FirstMondayAppointment> createState() =>
      _DeletingDoc2FirstMondayAppointmentState();
}

class _DeletingDoc2FirstMondayAppointmentState
    extends State<DeletingDoc2FirstMondayAppointment> {
