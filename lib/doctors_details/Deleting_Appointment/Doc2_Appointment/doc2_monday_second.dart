...
class DeletingDoc2SecondMondayAppointment extends StatefulWidget {
  final String? title;
  ...
  @override
  State<DeletingDoc2SecondMondayAppointment> createState() =>
      _DeletingDoc2SecondMondayAppointmentState();
}

class _DeletingDoc2SecondMondayAppointmentState
    extends State<DeletingDoc2SecondMondayAppointment> {
