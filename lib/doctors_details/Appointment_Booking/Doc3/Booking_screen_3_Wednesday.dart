...
class BookingScreen3Wednesday extends StatefulWidget {
  final String? title, description, description2, buttonText;
  final Image? image;

  BookingScreen3Wednesday(
      {this.title,
      this.description,
      this.description2,
      this.buttonText,
  ...
  @override
  State<BookingScreen3Wednesday> createState() =>
      _BookingScreen3WednesdayState();
}

class _BookingScreen3WednesdayState extends State<BookingScreen3Wednesday> {
                    ...
                    if (isChecked == true && isChecked2 == true) {
                      ...
                      if (isChecked == true) {
                        ...
                        FirebaseFirestore.instance
                            .collection("Appointment_Doc3_Wednesday")
                            .add(data)
                            .then((value) {
                          Map<String, dynamic> data = {
                            "email": user!.email,
