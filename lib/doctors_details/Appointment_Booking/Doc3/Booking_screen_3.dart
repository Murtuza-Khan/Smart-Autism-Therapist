...
class BookingScreen3Monday extends StatefulWidget {
  final String? title, description, description2, buttonText;
  final Image? image;

  BookingScreen3Monday(
      {this.title,
      this.description,
      this.description2,
      this.buttonText,
  ...
  @override
  State<BookingScreen3Monday> createState() => _BookingScreen3MondayState();
}

class _BookingScreen3MondayState extends State<BookingScreen3Monday> {
                    ...
                    if (isChecked == true && isChecked2 == true) {
                      ...
                      if (isChecked == true) {
                        ...
                        FirebaseFirestore.instance
                            .collection("Appointment_Doc3_Monday")
                            .add(data)
                            .then((value) {
                          Map<String, dynamic> data = {
                            "email": user!.email,
