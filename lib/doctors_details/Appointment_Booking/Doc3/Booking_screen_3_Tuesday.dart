...
class BookingScreen3Tuesday extends StatefulWidget {
  final String? title, description, description2, buttonText;
  final Image? image;

  BookingScreen3Tuesday(
      {this.title,
      this.description,
      this.description2,
      this.buttonText,
  ...
  @override
  State<BookingScreen3Tuesday> createState() => _BookingScreen3TuesdayState();
}

class _BookingScreen3TuesdayState extends State<BookingScreen3Tuesday> {
                    ...
                    if (isChecked == true && isChecked2 == true) {
                      ...
                      if (isChecked == true) {
                        ...
                        FirebaseFirestore.instance
                            .collection("Appointment_Doc3_Tuesday")
                            .add(data)
                            .then((value) {
                          Map<String, dynamic> data = {
                            "email": user!.email,
