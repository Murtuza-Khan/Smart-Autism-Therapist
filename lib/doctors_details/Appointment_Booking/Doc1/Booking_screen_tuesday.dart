...
class BookingScreenTuesday extends StatefulWidget {
  ...
  @override
  State<BookingScreenTuesday> createState() => _BookingScreenTuesdayState();
}

class _BookingScreenTuesdayState extends State<BookingScreenTuesday> {
                    ...
                    if (isChecked == true && isChecked2 == true) {
                      ...
                      if (isChecked == true) {
                        ...
                        FirebaseFirestore.instance
                            .collection("Appointment_Doc1_Tuesday")
                            .add(data)
                            .then((value) {
                          Map<String, dynamic> data = {
                            "email": user!.email,
