...
class BookingScreenWednesday extends StatefulWidget {
  ...
  @override
  State<BookingScreenWednesday> createState() => _BookingScreenWednesdayState();
}

class _BookingScreenWednesdayState extends State<BookingScreenWednesday> {
    ...
    userRef.get().then((QuerySnapshot snapshot) {
      snapshot.docs.forEach((DocumentSnapshot doc) {
        ...
        if (itemList[index]["isAvailable"] == "Booked" &&
            itemList[index]["appointment_time"] == "12:00 pm - 02:00 pm" &&
            itemList[index]["day"] == "Wednesday") {
          setState(() {
                    ...
                    if (isChecked == true && isChecked2 == true) {
                      ...
                      if (isChecked == true) {
                        ...
                        FirebaseFirestore.instance
                            .collection("Appointment_Doc1_Wednesday")
                            .add(data)
                            .then((value) {
                          Map<String, dynamic> data = {
                            "email": user!.email,
