...
class BookingScreen2Monday extends StatefulWidget {
  ...
  @override
  State<BookingScreen2Monday> createState() => _BookingScreen2MondayState();
}

class _BookingScreen2MondayState extends State<BookingScreen2Monday> {
                    ...
                    if (isChecked == true && isChecked2 == true) {
                      ...
                      if (isChecked == true) {
                        ...
                        FirebaseFirestore.instance
                            .collection("Appointment_Doc2_Monday")
                            .add(data)
                            .then((value) {
                          Map<String, dynamic> data = {
                            "email": user!.email,
