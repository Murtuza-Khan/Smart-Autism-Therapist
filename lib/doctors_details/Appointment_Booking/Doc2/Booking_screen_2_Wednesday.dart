...
class BookingScreen2Wednesday extends StatefulWidget {
  ...
  @override
  State<BookingScreen2Wednesday> createState() =>
      _BookingScreen2WednesdayState();
}

class _BookingScreen2WednesdayState extends State<BookingScreen2Wednesday> {
                    ...
                    if (isChecked == true && isChecked2 == true) {
                      ...
                      if (isChecked == true) {
                        ...
                        FirebaseFirestore.instance
                            .collection("Appointment_Doc2_Wednesday")
                            .add(data)
                            .then((value) {
                          Map<String, dynamic> data = {
                            "email": user!.email,
