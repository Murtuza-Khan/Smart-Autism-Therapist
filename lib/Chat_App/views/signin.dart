...
import 'package:admin/Chat_App/helper/theme.dart';
...
import 'package:admin/Chat_App/views/forgot_password.dart';
      ...
      await authService
        ...
        if (result != null)  {
          ...
          HelperFunctions.saveUserNameSharedPreference(
              userInfoSnapshot.docChanges[0].doc["userName"]);
          HelperFunctions.saveUserEmailSharedPreference(
              userInfoSnapshot.docChanges[0].doc["userEmail"]);
