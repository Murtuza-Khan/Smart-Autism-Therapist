...
class _VideoDownloadScreenState extends State<VideoDownloadScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    //     DateFormat.jm().format(DateTime.parse(widget.videoSort.toString()));
    // String formattedyear = DateFormat('yyyy-MM-dd')
    //     .format(DateTime.parse(widget.videoSort.toString()));
    return Scaffold(
      appBar: AppBar(
